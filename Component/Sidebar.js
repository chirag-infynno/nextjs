      ...
      <div className="flex flex-col gap-[24px] max-w-[984px]">
                ...
                <section className="sm: max-w-[970px] ">
                  <section className="flex  bg-white sm:flex-row gap-[24px] xs:flex-col  ">
                    ...
                    <aside className="flex flex-col py-[24px] sm:justify-between  xs:gap-[10px] xs:pl-[20px]  ">
                      ...
                      <section className="flex justify-between  px-[24px] items-center  sm:w-[500px]   xs:[400px] ">
        ...
        <div className="py-[64px] ">
          <ReactPaginate
            ...
            pageLinkClassName={""}
            previousClassName={
              "w-[36px] font-[700] h-[36px] flex items-center rounded-[6px] justify-center bg-[#28293D] text-white mr-[3px]"
            }
            previousLinkClassName={""}
            nextClassName={
              "w-[36px] h-[36px] font-[700] flex items-center justify-center rounded-[6px] bg-[#28293D] text-white"
            }
            nextLinkClassName={""}
            breakClassName={""}
            breakLinkClassName={""}
